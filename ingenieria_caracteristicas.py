...
def calcular_estadisticas_recientes(dataframe, equipo, fecha_partido, n=5):
    ...
    Parámetros:
    dataframe     : dataset completo de partidos.
    equipo        : nombre de la selección que se desea analizar.
    fecha_partido : fecha del partido que queremos predecir.
    n             : cantidad de partidos recientes a revisar.
...
# información previa suficiente, conservaremos partidos donde cada
# selección tenga por lo menos 3 partidos históricos previos.
